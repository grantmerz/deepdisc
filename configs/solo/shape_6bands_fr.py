...
from deepdisc.model.shear_models import CNNShearROIHeads, RedshiftPDFCasROIHeads, CNNShapeG_ROIHeads, CNNShape_psfROIHeads, CNNShapeG_weighted_ROIHeads, CNNShape_weighted_ROIHeads
