...
from deepdisc.model.shear_models import CNNShearROIHeads, RedshiftPDFCasROIHeads, CNNShapeG_ROIHeads, CNNShape_psfROIHeads
...
model.backbone.bottom_up.in_chans = 12


model.pixel_mean = [0.05829984, 
                    0.06376319,
                    0.09201837,
                    0.12189744,
                    0.16416408,
                    ...
                    0.00152307, 
                    0.00178378]
model.pixel_std = [1.67953887e+00,
                   1.34866697e+00,
                   1.85108223e+00,
                   2.57444103e+00,
                   3.38262852e+00,
...
model.backbone.square_pad = 262
model.roi_heads._target_ = CNNShapeG_ROIHeads #roiheads.RedshiftPDFCasROIHeads
